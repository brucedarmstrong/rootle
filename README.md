...
Every puzzle has a permanent URL of the form:

```
https://brucearmstrong.net/rootle/?puzzle=64
```

Visiting this link loads puzzle #64 directly, regardless of what day it is. This lets players challenge friends to a specific puzzle after solving it themselves.

The share text generated by the Share button automatically includes the challenge URL for the puzzle just played, along with a "Can you beat me?" callout.
